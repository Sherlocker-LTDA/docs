...
function creditQuickstartScene() {
  ...
  return `${grid("credit-quickstart-grid")}${sectionLabel("CNAB 400", 40, 58)}${sectionLabel("PROCESSAMENTO", 290, 58)}${sectionLabel("RESULTADOS", 548, 58)}${flowStep("file", "Enviar arquivo", 40, 150, 170, 110)}${arrows("M210 205H280", "M470 215H538")}${panel(290, 82, 180, 266, 13)}${statuses.map(([iconName, label], index) => `<g transform="translate(308 ${104 + index * 72})"><circle class="sk-timeline-dot" cx="12" cy="14" r="6" />${icon(iconName, 36, 0, 28)}<text class="sk-label" x="80" y="19">${label}</text>${index < statuses.length - 1 ? '<path class="sk-hair" d="M12 28v44" />' : ""}</g>`).join("")}<g transform="translate(548 102)">${panel(0, 0, 170, 226, 12)}${[0, 1, 2].map((index) => `<g transform="translate(14 ${18 + index * 66})"><rect class="sk-row-bg" width="142" height="52" rx="8" />${icon("receipt", 10, 14, 24)}<text class="sk-small-label" x="44" y="31">TÍTULO 0${index + 1}</text>${icon(index === 1 ? "alert" : "check", 112, 14, 24)}</g>`).join("")}</g>${connectionDot("M210 205H280", "4.8s")}${sharedSceneAnimation}`;
}
