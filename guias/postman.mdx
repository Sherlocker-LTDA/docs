...
<Frame>
  <img src="/images/sketches/integration-postman.svg" alt="O Postman funciona como canal de entrada para a mesma API." />
</Frame>
...
<Steps>
  <Step title="Baixar a collection">
    Faca download do arquivo [sherlocker-postman-collection.json](https://raw.githubusercontent.com/Sherlocker-LTDA/sherlocker-docs/refs/heads/main/sherlocker-postman-collection.json).
  </Step>
