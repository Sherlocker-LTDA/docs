...
```bash cURL
curl -X GET https://api.mycroft.com.br/api/v1/engines \
...
response = requests.get(
    "https://api.mycroft.com.br/api/v1/engines",
...
```javascript Node.js
const res = await fetch("https://api.mycroft.com.br/api/v1/engines", {
  headers: { "Authorization": "Bearer myc_sua_chave_aqui" }
});
