...
<Info>
Os **dados básicos** de cada entidade (nome, nascimento / razão social, situação...) vêm no campo `dados` do próprio nó — **não** são um módulo. Telefones, endereços e e-mails são módulos separados.
</Info>
