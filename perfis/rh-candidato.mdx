...
```mermaid
flowchart LR
  C["<div style='text-align:left'><b>👤 Candidato (CPF)</b><br/>📞 Telefones<br/>📍 Endereços<br/>✉️ E-mails<br/>⚖️ Processos<br/>🚔 Antecedentes criminais<br/>🚫 Listas restritivas<br/>💼 Histórico profissional</div>"]
  P["<div style='text-align:left'><b>👪 Parentes identificados</b><br/>⚖️ Processos<br/>🚔 Antecedentes criminais<br/>🚫 Listas restritivas</div>"]
  E["<div style='text-align:left'><b>🏢 Empresas vinculadas</b><br/>📅 Linha do tempo societária<br/>🚫 Listas restritivas</div>"]
      ...
      "empresas": [
        {
          ...
          "modulos": {
            "linha_do_tempo": { "status": "ok", "consultado_em": "...", "motivo": null, "eventos": [] }
          },
          "relacionados": {
            "socios": [
              {
