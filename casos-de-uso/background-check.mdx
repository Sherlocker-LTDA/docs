...
perfis_digitais = {}
for email in emails:
    perfis_digitais[email] = get(f"/registro/email/{email}")
```
...
<CardGroup cols={3}>
  ...
  <Card title="Empresas" icon="building" href="/api-reference/empresas/informações-básicas">
  ...
  <Card title="Rastro" icon="globe" href="/plataforma/rastro">
    Presença digital associada a email, telefone ou nome de usuário
  </Card>
</CardGroup>
