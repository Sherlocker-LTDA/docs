...
<Note>
  Não confunda com o **Motor de Crédito** (análise de borderô/CNAB, documentado em outra seção deste site). O Motor de Análise avalia o risco cadastral de um CNPJ ou CPF individual.
</Note>
