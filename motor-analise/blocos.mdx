...
Este catálogo cobre os blocos com escopo PJ e/ou PF. O Motor de Borderô também está disponível pela API `/v1`; seus blocos de título e NFe estão descritos em [Títulos e NFe](/credito/titulos-e-nfe) e [Engines](/motores/engines).
