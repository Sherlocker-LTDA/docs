...
Quando a operação chega a `completed`, o `GET /v1/operations/{id}/result` devolve a árvore **cedente → sacados → títulos**. Esta página é a referência do nó de título, do campo `nfe_chave` e da validação cruzada com os XMLs de NFe.
