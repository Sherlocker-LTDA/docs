...
<img src="/images/sketches/entity-ecosystem.svg" alt="Pessoa e empresa se conectam a patrimônio, processos e registros." />
...
## Motor de Análise (beta)

Além das consultas de dados, o Sherlocker oferece o **Motor de Análise**: uma API que roda uma análise de risco automatizada e completa de um CNPJ ou CPF — situação cadastral, sanções, processos, óbito, Serasa e mais — e devolve um veredito (`aprovado`, `alerta`, `reprovado` ou `incompleto`) com o resultado bloco a bloco. É uma API separada, com host e autenticação próprios.

<CardGroup cols={2}>
  <Card title="Motor de Análise" icon="gauge-high" href="/motor-analise/introducao">
    O que é, como funciona e como pedir acesso ao beta
  </Card>
  <Card title="Quickstart do Motor" icon="rocket" href="/motor-analise/quickstart">
    Da chave de API ao primeiro veredito em 3 passos
  </Card>
</CardGroup>
