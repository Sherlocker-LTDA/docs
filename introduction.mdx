...
Os dados do Sherlocker sao organizados em **6 categorias**. Cada categoria agrupa entidades do mesmo dominio:
...
graph LR
    ...
    style FIN fill:#FF6B6B33,stroke:#FF6B6B,color:#ccc
    style COM fill:#00BCD433,stroke:#00BCD4,color:#ccc
    style CRE fill:#E91E6333,stroke:#E91E63,color:#ccc
```

| Categoria | Entidades | Identificadores |
|-----------|-----------|----------------|
| **Cadastral** | Pessoa, Empresa, Telefone, Email, Endereco | CPF, CNPJ |
...
| **Financeiro** | Divida, Beneficio Social, Nota Fiscal | CPF, CNPJ, Chave NF-e |
| **Comportamental** | Registro Digital, Registro Comercial | Email, CPF |
| **Credito** | Operacao de Analise, Engine de Regras | CNPJ, UUID |
...
<CardGroup cols={2}>
  <Card title="Operacao de Credito" icon="file-circle-check" href="/entidades/operacao-credito">
    Analise CNAB 400 com regras
  </Card>
  <Card title="Engine de Regras" icon="gears" href="/entidades/engine-credito">
    Motores configuraveis
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Perfil Financeiro" icon="coins" href="/areas/financeiro">
    `GET /perfil/financeiro/cpf/{cpf}` — dividas + beneficios
  </Card>
  <Card title="Perfil Comportamental" icon="fingerprint" href="/areas/comportamento">
    `GET /registro/email/{email}` — registros digitais e comerciais
  </Card>
  <Card title="Sherlocker Credito" icon="credit-card" href="/areas/credito">
    `POST /credito/operacoes` — analise de credito para FIDCs
  </Card>
</CardGroup>
...
A collection esta organizada em 6 pastas: Perfis Agregados, Cadastro, Patrimonio, Juridico, Financeiro e Comportamento.
