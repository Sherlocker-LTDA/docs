...
<Note>
  ...
  Para confirmar em tempo real (D+0) o nome registrado na fonte oficial, sem
  depender do ciclo mensal após mudanças como nome social, casamento, divórcio
  ou retificação civil, considere [gerar uma certidão](/cadastro/certidoes).
</Note>
