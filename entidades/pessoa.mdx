...
<Note>
  A consulta de Pessoa reúne os dados consolidados e enriquecidos da Sherlocker.
  Para confirmar em tempo real (D+0) o nome associado ao CPF em uma fonte
  oficial, [gere uma Certidão Trabalhista](/cadastro/certidoes). A emissão
  consulta o TST no momento da solicitação e reduz divergências após mudanças
  recentes, como nome social, casamento, divórcio ou retificação civil.
</Note>
...
| Email | `GET /pessoas/email/{email}` | CPFs associados |
...
Os endpoints de busca reversa (`/pessoas/telefone/{telefone}`, `/pessoas/email/{email}`) suportam paginação:
...
<CardGroup cols={2}>
  <Card title="Dados básicos" icon="id-card" href="/api-reference/pessoas/informacoes-basicas">
    Nome, nascimento, sexo e vínculos familiares
  </Card>
  <Card title="Endereços" icon="location-dot" href="/api-reference/pessoas/enderecos">
    Histórico de endereços
  </Card>
  <Card title="Telefones" icon="phone" href="/api-reference/telefones/telefones-por-cpf">
    Telefones fixos e móveis
  </Card>
  <Card title="Emails" icon="envelope" href="/api-reference/emails/emails-por-cpf">
    Emails com score de confiabilidade
  </Card>
  <Card title="Parentes" icon="people-arrows" href="/api-reference/pessoas/informacoes-basicas">
...
<CardGroup cols={2}>
  <Card title="Sociedades" icon="building" href="/api-reference/busca-reversa/vinculos-societarios">
    Empresas onde a pessoa é sócia ou administradora
  </Card>
  <Card title="Empregos" icon="briefcase" href="/api-reference/pessoas/empregos">
...
<CardGroup cols={2}>
  ...
  <Card title="Dívidas" icon="file-invoice-dollar" href="/api-reference/dívidas/dívidas-federais-por-cpf">
  ...
  <Card title="Listas Restritivas" icon="shield-check" href="/api-reference/listas-restritivas/listas-restritivas-de-uma-pessoa">
    Sanções, impedimentos, PEP e leniência (11 listas)
  </Card>
</CardGroup>

### Presença digital

<Card title="Rastro" icon="globe" href="/plataforma/rastro">
  Presença pública associada a email, telefone ou nome de usuário
</Card>
...
5. **Verificar jurídico** — processos e listas restritivas
