...
<img src="/images/sketches/entity-empresa.svg" alt="Empresa e suas principais relações." />

Uma **Empresa** é identificada pelo CNPJ e representa uma pessoa jurídica registrada na Receita Federal.

<Note>
  Os dados cadastrais são atualizados mensalmente, conforme a disponibilização
  da base de dados da Receita Federal. Se precisar de dados em tempo real (D+0),
  [gere uma certidão](/cadastro/certidoes).
</Note>
