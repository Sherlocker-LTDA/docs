...
- **`POST /v1/operations`**: o payload multipart — o conteúdo dos arquivos (`file` e `xmls`) e os campos (`cedenteCnpj`, `engineId`, `purpose`, `legalBasis`). Trocar o arquivo, o ZIP ou qualquer campo com a mesma key gera conflito.
